// from https://github.com/maslianok/stickyRows
// Removed shifting from source.
(function($) {
  var uuid = 0;
  ...
  StickyRows.fn = $.StickyRows.prototype = {
    ...
    init: function(el, options) {
      ...
      this.scroll = {'vertical': false, 'horizontal': false};
    ...
    redraw: function(mode) {
      ...
      var containerScrollTop = (document.documentElement && document.documentElement.scrollTop) || this.container.$element.scrollTop();
    ...
    calculateDimensions: function() {
      ...
      if (!this.stickyHead) {
        ...
        this.stickyHead = {$element: $element, $table: $table, height: 0, marginTop: 0, changed: false};
      } else {
